...
public class Controller : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _displayGraph = GetComponentInChildren<DisplayGraph>();
    }
    ...
    private void Start()
    {
        ...
        Graph voronoiGraph = VoronoiDiagramGenerator.GenerateVoronoiFromDelaunay(triangulation);
